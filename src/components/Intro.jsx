    ...
    <div className="block intro">
      <h2 className="title box code">// Introduction </h2>
        ...
        <div className="introBlock about box">
            ...
            <p>Greetings! I'm Florian and I'm developping since 2019 so it's just the beginning but I aim at being better everyday.</p>
        </div>
     
      <div className="introBlock situation box">
